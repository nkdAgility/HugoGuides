...
- [x] Keep platform `main.yaml` focused on build/test/package and GitHub Release assets; keep `sample-main.yaml` a thin consumer of the same shared guide-site workflow.

...
Initial extraction deliberately reports unsupported work rather than pretending to complete it: full wrapper/i18n reconciliation, generated-PDF replacement/cache invalidation and existing-contributor updates remain E03 follow-up. Root Prepare/Build reporting is E04. Preserve the consumer's multilingual content structure and bespoke wrapper throughout.
